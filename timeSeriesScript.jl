"""
	exemplary time series: ARMA, Yule–Walker, constant ACF
	created: 2021, April
...
struct timeSeries
	Xt::Vector{Float64}	# hold the time series' elements
...
#	│	main
#	╰────────────────────────────────────────────────────
T= 1000; copies= 3; ts= timeSeries
distZ= Normal(0.0, 1.)		# Normal(0.0, 1.), Uniform(-1, 1), Cauchy(0, 1), Exponential(0.3)
